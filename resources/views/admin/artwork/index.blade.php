            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center">
                        <a href="{{ route('admin.artwork.show', ['id' => $artwork->getId()]) }}" class="btn btn-sm btn-outline-info me-1" title="View">
                        ...
                        <a href="{{route('admin.artwork.edit', ['id' => $artwork->getId()])}}" class="btn btn-sm btn-outline-warning me-1" title="Edit">
                ...
                @empty
                <tr>
                    <td colspan="5" class="text-center">No artworks yet.</td>
                </tr>
                @endforelse
            </tbody>
        </table>
