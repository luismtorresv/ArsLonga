            ...
            <div class="col-lg-7">
                <div class="card bg-dark rounded-4 border-warning border-2 text-white shadow-lg">
                    ...
                    <div class="card-body">
                        ...
                        @endif
                        <form method="POST"
                            action="{{ route('admin.artwork.save', ['id' => $viewData['artwork']->getId()]) }}"
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control bg-dark border-warning text-white" id="title"
                                    name="title" value="{{ old('title', $viewData['artwork']->getTitle()) }}" required>
                            </div>
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control bg-dark border-warning text-white" id="author"
                                    name="author" value="{{ old('author', $viewData['artwork']->getAuthor()) }}" required>
                            </div>
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control bg-dark border-warning text-white" id="keyword"
                                    name="keyword" value="{{ old('keyword', $viewData['artwork']->getKeyword()) }}">
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control bg-dark border-warning text-white" id="price"
                                    name="price" value="{{ old('price', $viewData['artwork']->getPrice()) }}">
                            </div>
                            <div class="col-12">
                                ...
                                @if ($viewData['artwork']->getImage())
                                    <div class="mt-2">
                                        <img src="{{ asset('/storage/' . $viewData['artwork']->getImage()) }}"
                                            alt="{{ __('admin.current') }}" class="img-thumbnail"
