                    ...
                    <div class="row g-0">
                        <div class="col-md-6 d-flex align-items-center justify-content-center p-4">
                            <img src="{{ asset('/storage/' . $viewData['artwork']->getImage()) }}"
                                class="img-fluid rounded-3 border-warning border border-2 shadow"
                                alt="{{ $viewData['artwork']->getTitle() }}" style="max-height: 400px;">
                        </div>
                        <div class="col-md-6 p-4">
                            <h2 class="fw-bold text-warning mb-3">{{ $viewData['artwork']->getTitle() }}</h2>
                            <h5 class="text-info mb-3">{{ __('admin.author') }}: <span
                                    class="fw-normal text-white">{{ $viewData['artwork']->getAuthor() }}</span></h5>
                            <div class="mb-3">
