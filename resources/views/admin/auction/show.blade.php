        ...
        <div class="card bg-dark rounded-4 border-warning border-2 text-white shadow-lg">
            ...
            <div class="row g-4">
              ...
              <div class="col-12">
                <div class="rounded-3 border-warning border p-4" style="background-color: #2d2d2d;">
                  ...
                  <div class="row g-3">
                    <div class="col-md-8">
                      <label class="text-warning small d-block mb-1">{{ __('admin.artworkTitle') }}</label>
                  ...
                  @if (isset($viewData['original_price']))
                    <div class="border-top border-secondary mt-3 pt-3">
                      <label class="text-warning small d-block mb-1">{{ __('admin.originalPrice') }}</label>
              ...
              <div class="col-12">
                <div class="rounded-3 border-warning border p-4" style="background-color: #2d2d2d;">
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <label class="text-warning small d-block mb-1">{{ __('admin.form.start_date') }}</label>
                    ...
                    <div class="col-md-6">
                      <label class="text-warning small d-block mb-1">{{ __('admin.form.final_date') }}</label>
                      <div class="fw-semibold text-white">
              ...
              <div class="col-12">
                <div class="rounded-3 border-secondary border p-4" style="background-color: #2d2d2d;">
                  ...
                  <div class="row small">
                    <div class="col-md-4">
                      <label class="text-secondary small d-block mb-1">{{ __('admin.created') }}</label>
                      <span class="text-white-50">
                        {{ $viewData['auction']->getCreatedAt() ? $viewData['auction']->getCreatedAt()->format('M d, Y H:i:s') : 'N/A' }}
                      </span>
                    </div>
                    <div class="col-md-4">
                      <label class="text-secondary small d-block mb-1">{{ __('admin.updated') }}</label>
                      <span class="text-white-50">
                        {{ $viewData['auction']->getUpdatedAt() ? $viewData['auction']->getUpdatedAt()->format('M d, Y H:i:s') : 'N/A' }}
                      </span>
                    </div>
                    <div class="col-md-4">
                      <label class="text-secondary small d-block mb-1">{{ __('admin.auctionId') }}</label>
          ...
          <div class="card-footer bg-dark rounded-bottom-4 border-top border-warning">
            <div class="d-flex justify-content-between align-items-center">
              ...
              <form action="{{ route('admin.auction.delete', ['id' => $viewData['auction']->getId()]) }}" method="POST"
                onsubmit="return confirm('{{ __('admin.confirmDelete') }}');">
                @csrf
                @method('DELETE')
