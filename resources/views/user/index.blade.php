  ...
  <div class="d-flex justify-content-center align-items-center min-vh-50">
    <div class="card bg-dark rounded-3 p-4 text-white shadow-lg" style="max-width: 400px; width: 100%;">
      <div class="d-flex flex-column align-items-center">
        <img
          src="https://ui-avatars.com/api/?name={{ urlencode($viewData['user']->getName()) }}&background=23272b&color=fff&size=128"
        ...
        <a href="{{ route('user.edit') }}" class="btn btn-warning w-100 fw-bold mt-3">{{ __('user.editProfile') }}</a>
      </div>
    </div>
  </div>
@endsection
