                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('auction.save') }}">
                            @csrf
                            <input type="text" class="form-control mb-2" placeholder="Enter the artwork's price"
                                name="original_price" value="{{ old('original_price') }}" />
                            <input type="text" class="form-control mb-2" placeholder="Enter the artwork's final price"
                            ...
                            <input type="text" class="form-control mb-2" placeholder="Enter the artwork's ID"
                                name="artwork_id" value="{{ old('artwork_id') }}" />
